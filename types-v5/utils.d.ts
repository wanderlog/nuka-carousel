...
export declare const addEvent: (elem: Window | Document, type: string, eventHandle: EventListener) => void;
export declare const removeEvent: (elem: Window | Document, type: string, eventHandle: EventListener) => void;
