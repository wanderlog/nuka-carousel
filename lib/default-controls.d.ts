...
export declare const PreviousButton: (props: ControlProps) => import("react/jsx-runtime").JSX.Element;
...
export declare const NextButton: (props: ControlProps) => import("react/jsx-runtime").JSX.Element;
...
export declare const PagingDots: (props: ControlProps) => import("react/jsx-runtime").JSX.Element;
