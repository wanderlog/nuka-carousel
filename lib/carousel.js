...
exports.Carousel = react_1.default.forwardRef(function Carousel(rawProps, ref) {
    /**
    ...
    (0, react_1.useImperativeHandle)(ref, () => ({ moveSlide, nextSlide, prevSlide }));
    ...
    const handleDragEnd = (0, react_1.useCallback)((e) => {
        ...
        const adjustedMove = (0, utils_1.rtlMultiplier)() * move;
        if (adjustedMove > 0) {
            prevSlide();
        }
        else {
