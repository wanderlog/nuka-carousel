...
var defaultRenderAnnounceSlideMessage = exports.defaultRenderAnnounceSlideMessage = function defaultRenderAnnounceSlideMessage(_ref2) {
  var currentSlide = _ref2.currentSlide,
    count = _ref2.count;
  return "Slide ".concat(currentSlide + 1, " of ").concat(count);
};
var _default = exports["default"] = AnnounceSlide;